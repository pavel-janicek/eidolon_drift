    ...
    def trigger(self, event_def, sector):
        ...
        if etype == "linger_damage":
            ...
            if self.game.player.health <= 0:
                ...
                self.game.handle_death(event_def.get("death_message", "You succumbed to your injuries."))
            ...
            anomaly = {
                ...
                "description": event_def.get("description", "A newly formed anomaly pulses here."),
